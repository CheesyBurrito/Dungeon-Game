...
public class DungeonGame {
	...
	//This method contains which method to load for each element of the game
	...
	public static void mapCreation(){
		...
		if(userChoiceChar == '1')
			dungeonMap = new Map(10);
		
		else if(userChoiceChar == '2')
			dungeonMap = new Map(20);
		
		else if(userChoiceChar == '3')
			dungeonMap = new Map(35);
		
		else if(userChoiceChar == '4')
			dungeonMap = new Map(55);
	...
	public static void healingPotion(){
		...
		if(userHeros.getNumOfPotions() > 0){
			...
			//Calculates the amount of hp t0 restore
