...
/**
 * Title:       Hero.java
 * Description: Creates the hero Object
 * 
 * @author:     SWAG
 * 
 * @version:    1.0
...
public class Hero {
	...
	private int defense;  //Defense points of a type of hero (Depends on the type of hero chose. See requirements for details)
